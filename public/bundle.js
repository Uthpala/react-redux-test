...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReducerFilter = __webpack_require__(193);
	...
	var rootReducer = (0, _redux.combineReducers)({
	  filter: _ReducerFilter2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserTable = __webpack_require__(197);
	...
	var Filter = function (_React$Component) {
	    ...
	    _createClass(Filter, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var users = [{ id: 1, name: 'Alex', gender: 'male' }, { id: 2, name: 'John', gender: 'male' }, { id: 3, name: 'Anna', gender: 'female' }, { id: 4, name: 'Kate', gender: 'female' }, { id: 5, name: 'Lisa', gender: 'female' }];
	            return _react2.default.createElement(
	                'div',
	                null,
	                ...
	                _react2.default.createElement(_UserTable2.default, { users: users, filterState: this.props.filterState })
	            );
	        }
	    }]);
	...
	function mapDispatchToProps(dispatch) {
	    return (0, _redux.bindActionCreators)({ filterTable: _index.filterTable }, dispatch);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserRow = __webpack_require__(198);
	...
	var UserTable = function (_React$Component) {
	    ...
	    function UserTable() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(UserTable).apply(this, arguments));
	    }
	    ...
	    _createClass(UserTable, [{
	        ...
	        value: function render() {
	            ...
	            this.props.users.forEach(function (user) {
	                ...
	                if (user.name.toLowerCase().indexOf(_this2.props.filterState.filterText) === -1 || user.gender === 'male' && !_this2.props.filterState.male || user.gender === 'female' && !_this2.props.filterState.female || !_this2.props.filterState.male && !_this2.props.filterState.female) {
	                    return;
	                }

	                rows.push(_react2.default.createElement(_UserRow2.default, { key: user.id, name: user.name, gender: user.gender }));
	            });
	            return _react2.default.createElement(
	                'table',
	                { className: 'table' },
